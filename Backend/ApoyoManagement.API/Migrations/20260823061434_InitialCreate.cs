        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mobile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkforceCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EstimatedStaffSize = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorporateLeads", x => x.Id);
                });
